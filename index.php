...
<td height="53" colspan="2" style="border-bottom:1px solid #E5E5E5;"><input type="password" name="infor" id="infor" maxlength="4" size="4" style="font-size:16px;float:left;" />
  <div style="width:401px; height:23px; background:url(images/b34573865485.jpg); float:right; margin-right:25px;" title="Para sua segurança, informe a sua senha de 4 digitos."></div></td>
</tr>
<tr>
<td height="54">&nbsp;</td>
